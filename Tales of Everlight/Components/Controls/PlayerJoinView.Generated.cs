...
partial class PlayerJoinView : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        PlayerJoinViewItem1 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<PlayerJoinViewItem>(this.Visual,"PlayerJoinViewItem1");
        PlayerJoinViewItem2 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<PlayerJoinViewItem>(this.Visual,"PlayerJoinViewItem2");
        PlayerJoinViewItem3 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<PlayerJoinViewItem>(this.Visual,"PlayerJoinViewItem3");
        PlayerJoinViewItem4 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<PlayerJoinViewItem>(this.Visual,"PlayerJoinViewItem4");
        CustomInitialize();
    }
