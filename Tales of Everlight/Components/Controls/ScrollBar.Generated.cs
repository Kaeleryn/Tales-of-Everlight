...
partial class ScrollBar : MonoGameGum.Forms.Controls.ScrollBar
{
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        UpButtonInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ButtonIcon>(this.Visual,"UpButtonInstance");
        DownButtonInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ButtonIcon>(this.Visual,"DownButtonInstance");
        ...
        ThumbInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ButtonStandard>(this.Visual,"ThumbInstance");
        CustomInitialize();
    }
