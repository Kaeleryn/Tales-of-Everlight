//Code for Controls/ButtonConfirm1 (Container)
using GumRuntime;
...
partial class ButtonConfirm1 : MonoGameGum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/ButtonConfirm1");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new ButtonConfirm1(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(ButtonConfirm1)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/ButtonConfirm1", () => 
        {
    ...
    public ButtonConfirm1(InteractiveGue visual) : base(visual) { }
    public ButtonConfirm1()
    {
