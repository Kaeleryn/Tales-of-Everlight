...
partial class InputDeviceSelector : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        InputDeviceSelectionItemInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<InputDeviceSelectionItem>(this.Visual,"InputDeviceSelectionItemInstance");
        InputDeviceSelectionItemInstance1 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<InputDeviceSelectionItem>(this.Visual,"InputDeviceSelectionItemInstance1");
        InputDeviceSelectionItemInstance2 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<InputDeviceSelectionItem>(this.Visual,"InputDeviceSelectionItemInstance2");
        InputDeviceSelectionItemInstance3 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<InputDeviceSelectionItem>(this.Visual,"InputDeviceSelectionItemInstance3");
        CustomInitialize();
    }
