//Code for Controls/CustomButton (Container)
using GumRuntime;
...
partial class CustomButton : MonoGameGum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/CustomButton");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new CustomButton(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(CustomButton)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/CustomButton", () => 
        {
    ...
    public CustomButton(InteractiveGue visual) : base(visual) { }
    public CustomButton()
    {
