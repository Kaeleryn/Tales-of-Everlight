...
partial class TreeViewItem : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        ToggleButtonInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<TreeViewToggle>(this.Visual,"ToggleButtonInstance");
        ListBoxItemInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ListBoxItem>(this.Visual,"ListBoxItemInstance");
