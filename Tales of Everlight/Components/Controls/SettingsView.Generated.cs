...
partial class SettingsView : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        FullscreenCheckboxInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<CheckBox>(this.Visual,"FullscreenCheckboxInstance");
        MusicVolumeLabel = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<Label>(this.Visual,"MusicVolumeLabel");
        MusicSliderInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<Slider>(this.Visual,"MusicSliderInstance");
        SoundVolumeLabel = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<Label>(this.Visual,"SoundVolumeLabel");
        SoundSliderInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<Slider>(this.Visual,"SoundSliderInstance");
        CustomInitialize();
    }
