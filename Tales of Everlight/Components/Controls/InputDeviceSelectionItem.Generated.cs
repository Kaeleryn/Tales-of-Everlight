...
partial class InputDeviceSelectionItem : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        RemoveDeviceButtonInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ButtonClose>(this.Visual,"RemoveDeviceButtonInstance");
        CustomInitialize();
    }
