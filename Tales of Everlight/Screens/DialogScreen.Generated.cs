...
partial class DialogScreen : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("DialogScreen");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new DialogScreen(visual);
            visual.Width = 0;
        ...
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(DialogScreen)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("DialogScreen", () => 
        {
    ...
    public DialogScreen(InteractiveGue visual) : base(visual) { }
    public DialogScreen()
    {
