...
partial class DialogScreenTheEnd : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("DialogScreenTheEnd");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new DialogScreenTheEnd(visual);
            visual.Width = 0;
        ...
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(DialogScreenTheEnd)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("DialogScreenTheEnd", () => 
        {
    ...
    public DialogScreenTheEnd(InteractiveGue visual) : base(visual) { }
    public DialogScreenTheEnd()
    {
